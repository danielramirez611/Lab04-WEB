 ...
 * @author Usuario
 */
@WebServlet(name = "ServletVerificar", urlPatterns = {"/ServletVerificar"})
     ...
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (xusu.equals(usuario) && xpas.equals(clave)){
                response.sendRedirect("/WebApplication1/formularioReservas.jsp");
            }else{
                response.sendRedirect("/WebApplication1/error_acceso.html");
            }
        } catch (IOException e) {
